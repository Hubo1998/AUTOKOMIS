...
public class Generate {
    ...
    public static Integer genModel(Integer random){
        //Miałem bazę danych z pojazdami i ich modelami, wszystko skopiowałem i modele są odpowiednio przypisane do marek samochodów.
        Random rand=new Random();
        int y;
        switch (random){
            case 0->y= rand.nextInt(26);
            case 1->y= rand.nextInt(20)+26;
            case 2->y= rand.nextInt(6)+46;
            case 3->y= rand.nextInt(8)+52;
            case 4->y= rand.nextInt(13)+60;
            case 5->y= rand.nextInt(13)+73;
            case 6->y= rand.nextInt(13)+86;
            case 7->y= rand.nextInt(24)+99;
            case 8->y= rand.nextInt(15)+123;
            case 9->y= rand.nextInt(16)+138;
            case 10->y= rand.nextInt(8)+154;
            case 11->y= rand.nextInt(5)+162;
            case 12->y= rand.nextInt(22)+167;
            case 13->y= rand.nextInt(33)+189;
            case 14->y= rand.nextInt(22)+222;
            case 15->y= rand.nextInt(5)+244;
            case 16->y= rand.nextInt(28)+249;
            case 17->y= rand.nextInt(22)+277;
            case 18->y= rand.nextInt(20)+299;
            case 19->y= rand.nextInt(28)+319;
            case 20->y= rand.nextInt(40)+347;
            case 21->y= rand.nextInt(38)+387;
            case 22->y= rand.nextInt(3)+425;
            case 23->y= rand.nextInt(21)+428;
            case 24->y= rand.nextInt(8)+449;
            case 25->y= rand.nextInt(5)+457;
            case 26->y= rand.nextInt(13)+462;
            case 27->y= rand.nextInt(20)+475;
            case 28->y= rand.nextInt(9)+495;
            case 29->y= rand.nextInt(5)+504;
            case 30->y= rand.nextInt(22)+509;
            case 31->y= rand.nextInt(42)+531;
            case 32->y= rand.nextInt(10)+573;
            case 33->y= rand.nextInt(26)+583;
            case 34->y= rand.nextInt(5)+609;
            case 35->y= rand.nextInt(27)+614;
            case 36->y= rand.nextInt(36)+641;
            case 37->y= rand.nextInt(36)+641;
            case 38->y= rand.nextInt(9)+677;
            case 39->y= rand.nextInt(23)+686;
            case 40->y= rand.nextInt(16)+709;
            case 41->y= rand.nextInt(2)+725;
            case 42->y= rand.nextInt(3)+727;
            case 43->y= rand.nextInt(13)+730;
            case 44->y= rand.nextInt(13)+743;
            case 45->y= rand.nextInt(5)+756;
            case 46->y= rand.nextInt(4)+761;
            default -> y=0;
        }
